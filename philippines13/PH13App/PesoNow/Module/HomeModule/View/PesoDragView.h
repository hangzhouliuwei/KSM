...
/**
 点击的回调block
 */
@property (nonatomic,copy) void(^clickDragViewBlock)(PesoDragView *dragView);
/**
 开始拖动的回调block
 */
@property (nonatomic,copy) void(^beginDragBlock)(PesoDragView *dragView);
/**
 拖动中的回调block
 */
@property (nonatomic,copy) void(^duringDragBlock)(PesoDragView *dragView);
/**
 结束拖动的回调block
 */
@property (nonatomic,copy) void(^endDragBlock)(PesoDragView *dragView);
@end
