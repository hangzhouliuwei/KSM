...
private func xtVerifyActivate(_ constraints: [NSLayoutConstraint]) {
    NSLayoutConstraint.activate(constraints)
}

private func xtVerifyPoint(productId: String, startTime: String, type: String) -> [String: Any] {
    [
...
private func xtVerifyEnsureLocation() {
...
private func xtVerifyShowOverlay(_ overlay: UIView, from view: UIView) {
    let host = XT_AppDelegate?.window ?? view
    overlay.frame = host.bounds
    host.addSubview(overlay)
}

private extension XTBaseVC {
