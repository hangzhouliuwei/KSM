...
// 拖曳view的方向
typedef NS_ENUM(NSInteger, PUBDragDirection) {
    PUBDragDirectionAny,          /**< 任意方向 */
    PUBDragDirectionHorizontal,   /**< 水平方向 */
    PUBDragDirectionVertical,     /**< 垂直方向 */
};
@interface PUBDragView : UIView
/**
 是不是能拖曳，默认为YES
 YES，能拖曳
 NO，不能拖曳
...
/**
 拖曳的方向，默认为any，任意方向
 */
@property (nonatomic,assign) PUBDragDirection dragDirection;
...
/**
 点击的回调block
 */
@property (nonatomic,copy) void(^clickDragViewBlock)(PUBDragView *dragView);
/**
 开始拖动的回调block
 */
@property (nonatomic,copy) void(^beginDragBlock)(PUBDragView *dragView);
/**
 拖动中的回调block
 */
@property (nonatomic,copy) void(^duringDragBlock)(PUBDragView *dragView);
/**
 结束拖动的回调block
 */
@property (nonatomic,copy) void(^endDragBlock)(PUBDragView *dragView);
@end
