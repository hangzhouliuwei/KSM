...
- (void)updateUIWithModel:(BagHomeSmallCardModel *)model
{
    ...
    _amountLabel.text = model.eahofourteenleNc;
    _amountDescLabel.text = model.cotefourteennderNc;
    _applyBtn.backgroundColor = [UIColor qmui_colorWithHexString:model.spfffourteenlicateNc];
    [_applyBtn setTitle:NotNull(model.maanfourteenNc) forState:UIControlStateNormal];
    _rate.text = model.fianfourteencialNc;
    _rateDesc.text = model.fatifourteenshNc;
    _period.text = model.urtefourteenrNc;
    _periodDesc.text = model.paadfourteenosNc;
}
- (void)cellClick{
