...
+(NSString *)getIDFV
{
    NSString * currentDeviceUUIDStr = [SSKeychain passwordForService:@"com.bag"account:@"uuid"];
    if (currentDeviceUUIDStr == nil || [currentDeviceUUIDStr isEqualToString:@""])
    {
        NSUUID * currentDeviceUUID  = [UIDevice currentDevice].identifierForVendor;
        currentDeviceUUIDStr = currentDeviceUUID.UUIDString;
        [SSKeychain setPassword: currentDeviceUUIDStr forService:@"com.bag"account:@"uuid"];
    }
    return currentDeviceUUIDStr;
}
+ (NSString *)getUUID{
    NSString * currentDeviceUUIDStr = [SSKeychain passwordForService:@"com.bag"account:@"QCUUID"];
    if (currentDeviceUUIDStr == nil || [currentDeviceUUIDStr isEqualToString:@""])
    {
        currentDeviceUUIDStr = [NSUUID UUID].UUIDString;
        [SSKeychain setPassword: currentDeviceUUIDStr forService:@"com.bag"account:@"QCUUID"];
    }
    return currentDeviceUUIDStr;
}
//获取网络状态
