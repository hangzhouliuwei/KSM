...
//  WZDai
//
//  Created by oscarzhu on 14-3-26.
//
//

#ifndef IPhone_Shortcut_h
#define IPhone_Shortcut_h

#define NotNull(str) [Util isValidString:str] ? str : @""
...
#define Home_BANNER @"AAFOURTEENAV"
#define Home_RIDING_LANTERN @"AAFOURTEENAW"
#define Home_LARGE_CARD @"AAFOURTEENAX"
#define Home_SMALL_CARD @"AAFOURTEENAY"
#define Home_PRODUCT_LIST @"AAFOURTEENAZ"
