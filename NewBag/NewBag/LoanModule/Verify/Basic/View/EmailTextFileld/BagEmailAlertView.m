...
- (void)certUI
{
    [self.tableView registerNib:[Util getNibFromeBundle:NSStringFromClass(EmailAlertListCell.class)] forCellReuseIdentifier:NSStringFromClass(EmailAlertListCell.class)];
