...
- (void)setupUI{
    ...
    [closeBtn sd_setImageWithURL:[Util loadImageUrl:@"baisc_single_close"] forState:UIControlStateNormal];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([model isKindOfClass: BagBaseModel.class]) {
        ...
        [cell updateUIWithModel:enumModel.uporfourteennNc isSelected:indexPath.section == self.selectIndex];
    }
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        [_tableView registerNib:[Util getNibFromeBundle:NSStringFromClass(BagVerifyPickerCell.class)] forCellReuseIdentifier:NSStringFromClass(BagVerifyPickerCell.class)];
    }
    return _tableView;
}
- (UIView *)bgView
