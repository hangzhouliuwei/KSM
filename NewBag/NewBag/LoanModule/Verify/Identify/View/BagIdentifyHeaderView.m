...
{
    [self.idCardImage sd_setImageWithURL:[NSURL URLWithString:model.ovrpfourteenunchNc] placeholderImage:[UIImage imageNamed:@"identify_bg"]];
    self.selectIDNameLabel.text = NotNull(model.roanfourteenizeNc);
//    self.selectIDNameLabel.font = [PUBTools isBlankString:model.roanfourteenizeNc] ? FONT(13.f) : FONT_Semibold(16.f);
    self.selectIdCardNo = model.ceNcfourteen;
