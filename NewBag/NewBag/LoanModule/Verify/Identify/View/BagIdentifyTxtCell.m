...
{
    _title.text = model.fldgfourteeneNc;
    if(![model.daryfourteenmanNc br_isBlankString]){
        self.inputTextfield.text = NotNull(model.daryfourteenmanNc);
    }else{
    ...
    self.inputTextfield.keyboardType = model.techfourteenedNc.integerValue == 1 ? UIKeyboardTypeNumberPad : UIKeyboardTypeDefault;
