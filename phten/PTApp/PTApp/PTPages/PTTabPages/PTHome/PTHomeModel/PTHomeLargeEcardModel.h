...
@interface PTHomeLargeEcardItemModel : PTHomeBaseModel
///产品id
...
@interface PTHomeLargeEcardModel : PTHomeBaseModel
@property(nonatomic, copy) NSString *ittenlianizeNc;
@property(nonatomic, copy) NSArray <PTHomeLargeEcardItemModel*>*gutengoyleNc;
@end
