...
@interface NSTimer (PTCountDownButtonBlocksSupport)
+ (NSTimer *)jkcd_scheduledTimerWithTimeInterval:(NSTimeInterval)interval
                                           block:(void(^)(void))block
                                         repeats:(BOOL)repeats;
@end

@interface PTCountDownButton ()
{
...
@implementation PTCountDownButton
...
- (void)touched:(PTCountDownButton*)sender{
...
@implementation NSTimer (GCCountDownButtonBlocksSupport)
+ (NSTimer *)jkcd_scheduledTimerWithTimeInterval:(NSTimeInterval)interval
                                           block:(void(^)(void))block
                                         repeats:(BOOL)repeats
{
