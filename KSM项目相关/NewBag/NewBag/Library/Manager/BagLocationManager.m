...
- (void)uploadLocation
{
    ...
    NSDictionary *param = @{
        @"meonfourteenymNc":NotNull(self.admin_area),
        @"prgefourteennitureNc":NotNull(self.country_code),
        @"emlufourteenmentNc":NotNull(self.country),
        @"meadfourteenaltonNc":NotNull(self.feature_name),
        @"unevfourteenoutNc":@(self.longitude),
        @"boomfourteenofoNc":@(self.latitude),
        @"googfourteenenesisNc":NotNull(self.locality),
        @"amitfourteeniouslyNc":NotNull(self.sub_admin_area),
    };
