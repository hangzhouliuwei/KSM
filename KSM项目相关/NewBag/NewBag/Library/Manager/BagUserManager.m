...
- (void)initUser{
    if ([self.cache objectForKey:@"loginCache"]) {
        ...
        _chromatogramF = _model.phsifourteenographicalNc;
        _smsMaxId = _model.heerfourteenochromaticNc;
        _uid = _model.bamyfourteenNc;
        _username = _model.stwafourteenrdessNc;
        _is_aduit = _model.aoNcfourteen;
        _token = _model.tetofourteengenesisNc;
        _sessionid = _model.fifofourteenotedNc;
    }else{
