...
- (NSString *)br_pinProductId:(NSString *)product_id
{
    if ([self containsString:@"http"] || [self containsString:@"https"]) {
        return self;
    }
    
    if (![self containsString:@"lietfourteenusNc"]) {
        if ([self containsString:@"?"]) {
            return [NSString stringWithFormat:@"%@lietfourteenusNc=%@",self,product_id];
        }
        return [NSString stringWithFormat:@"%@?lietfourteenusNc=%@",self,product_id];
    }
    return self;
