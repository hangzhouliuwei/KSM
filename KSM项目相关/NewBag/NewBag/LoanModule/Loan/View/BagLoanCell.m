...
{
    [_iconImageView sd_setImageWithURL:[NSURL URLWithString:model.doabfourteenleNc] placeholderImage:[UIImage qmui_imageWithColor:[UIColor qmui_colorWithHexString:@"#999999"]]];
