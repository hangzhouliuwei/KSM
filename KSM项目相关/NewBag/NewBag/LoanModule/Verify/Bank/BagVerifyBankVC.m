...
- (void)onNextClick{
    ...
    if(self.segmentView.selecctIndex == 0){
        ...
        dic[@"ceNcfourteen"] = @"2";
        dic[@"blthfourteenelyNc"] = @(self.walletView.selectModel.regnfourteenNc);
        dic[@"ovrcfourteenutNc"] = NotNull(self.walletView.walletText);
        textStr = self.walletView.selectModel.uporfourteennNc;
        ...
        dic[@"ceNcfourteen"] = @"1";
        dic[@"blthfourteenelyNc"] = @(self.bankView.selectModel.regnfourteenNc);
        dic[@"ovrcfourteenutNc"] = NotNull(self.bankView.bankText);
        textStr = self.bankView.selectModel.uporfourteennNc;
...
- (void)updateUIWithModel:(BagBankModel *)model
{
    ...
    [self.walletView updateUIWithModel:model.abenfourteentlyNc];
    [self.bankView updateUIWithModel:model.murafourteenyNc];
}
