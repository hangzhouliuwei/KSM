...
- (void)updateUIWithModel:(BagHomeBigCardItemModel *)model
{
    ...
    _rateLabel.text = model.fianfourteencialNc;
    _rateDescLabel.text = model.fatifourteenshNc;
    _periodLabel.text = model.urtefourteenrNc;
    _periodDescLabel.text = model.paadfourteenosNc;
