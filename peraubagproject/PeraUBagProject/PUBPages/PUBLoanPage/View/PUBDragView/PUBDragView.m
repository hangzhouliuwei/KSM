...
@interface PUBDragView()<UIGestureRecognizerDelegate>
...
-(UIImageView *)imageView{
    if (_imageView==nil) {
        ...
        _imageView.image = [UIImage imageNamed:@"customer_icon"];
    ...
    switch (pan.state) {
        ...
        case UIGestureRecognizerStateChanged:{//拖动中
            ...
            switch (self.dragDirection) {
                case PUBDragDirectionAny:
                    dx = point.x - self.startPoint.x;
                    dy = point.y - self.startPoint.y;
                    break;
                case PUBDragDirectionHorizontal:
                    dx = point.x - self.startPoint.x;
                    dy = 0;
                    break;
                case PUBDragDirectionVertical:
                    dx = 0;
                    dy = point.y - self.startPoint.y;
                    break;
                default:
