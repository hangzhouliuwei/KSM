...
@interface PUBSingleView ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic, strong) UIView *alertView;
@property(nonatomic, copy) NSArray <PUBBasicHorrificEgModel*>*dataArr;
@property(nonatomic, copy) NSString *title;
@property (nonatomic ,strong) UITableView *tableView;
@property (nonatomic ,assign) NSInteger index;
@end

@implementation PUBSingleView
...
- (void)nextBtnClick
{
    ...
    if(self.dataArr.count > self.index && self.confirmBlock){
        PUBBasicHorrificEgModel *model = [self.dataArr objectAtIndex:self.index];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
   ...
   static NSString*cellID = @"PUBSingleCellID";
    ...
    PUBBasicHorrificEgModel *model = [self.dataArr objectAtIndex:indexPath.row];
    [cell configModel:model seleIndex:self.index index:indexPath.row];
    return cell;
