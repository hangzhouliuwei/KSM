...
@interface PUBBankSingleView()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic, strong) UIView *alertView;
@property(nonatomic, copy) NSArray <PUBBankLysinEgModel*>*dataArr;
@property(nonatomic, copy) NSString *title;
@property (nonatomic ,strong) UITableView *tableView;
@property (nonatomic ,assign) NSInteger index;
@end

@implementation PUBBankSingleView
...
- (void)nextBtnClick
{
   ...
   if(self.dataArr.count > self.index && self.confirmBlock){
       PUBBankLysinEgModel *model = [self.dataArr objectAtIndex:self.index];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  static NSString*cellID = @"PUBSingleCellID";
   ...
   if(!cell){
    ...
    PUBBankLysinEgModel *model = [self.dataArr objectAtIndex:indexPath.row];
   [cell configBankModel:model seleIndex:self.index index:indexPath.row];
   return cell;
