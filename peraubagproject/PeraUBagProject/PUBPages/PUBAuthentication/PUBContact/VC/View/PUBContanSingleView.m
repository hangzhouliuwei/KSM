...
@interface PUBContanSingleView ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic, strong) UIView *alertView;
@property(nonatomic, copy) NSArray <PUBContactFeatherstitchEgModel*>*dataArr;
@property(nonatomic, copy) NSString *title;
@property (nonatomic ,strong) UITableView *tableView;
@property (nonatomic ,assign) NSInteger index;
@end

@implementation PUBContanSingleView
- (void)show {
...
- (void)nextBtnClick
{
    ...
    if(self.dataArr.count > self.index && self.confirmBlock){
        PUBContactFeatherstitchEgModel *model = [self.dataArr objectAtIndex:self.index];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
   ...
   static NSString*cellID = @"PUBSingleCellID";
    ...
    PUBContactFeatherstitchEgModel *model = [self.dataArr objectAtIndex:indexPath.row];
    [cell configContanModel:model seleIndex:self.index index:indexPath.row];
    return cell;
