...
@property (weak, nonatomic) IBOutlet UIImageView *bankTopImageView;
...
{
    [super awakeFromNib];
    [self.bankTopImageView sd_setImageWithURL:[Util loadImageUrl:@"bank_confirm"]];
...
+ (instancetype)createView{
    BagBankSaveConfirmView *bank = [Util getSourceFromeBundle:NSStringFromClass(self.class)];;
    return bank;
}
- (void)show
{
